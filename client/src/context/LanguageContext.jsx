...
const translations = {
  en: {
    ...
    'game.server_reconnecting': 'Server is restarting...',
    'game.server_reconnecting_sub': 'Game will resume automatically',
  ...
  ua: {
    ...
    'game.server_reconnecting': 'Сервер перезавантажується...',
    'game.server_reconnecting_sub': 'Гра продовжиться автоматично',
